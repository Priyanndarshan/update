...
import { BarChart2, Facebook, Twitter, Instagram, Linkedin, Mail } from 'lucide-react';
    ...
    <footer className="py-8 px-6 text-gray-600 border-t border-gray-200 bg-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-blue-600 to-teal-500 bg-clip-text text-transparent">Profitever Traders</span>
            </div>
            <p className="text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:support@profitevertraders.com" className="hover:text-blue-600">support@profitevertraders.com</a>
              </li>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} Profitever Traders. All rights reserved.</p>
